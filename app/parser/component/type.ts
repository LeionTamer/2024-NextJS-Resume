...
export const parsedDescriptionSchema = z.object({
  ...
  projectManagmentTools: z.array(z.string()),
})
...
You are a recruiter for a tech company. Please provide a concise summary for a professional profile based on the following parameters:
